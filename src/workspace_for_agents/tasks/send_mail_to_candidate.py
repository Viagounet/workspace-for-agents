...
def setup_task(env: Environment) -> Task:
    TALKED_TO_IBRAHIM = Goal(name="talk-to-ibrahim", conditions=[has_sent_email(env.agent, "ibrahim.mendoza@company.com")])
    SENT_EMAIL_TO_TARIQ = Goal(name="send-mail-to-tariq", conditions=[has_sent_email(env.agent, "tariq.hassan@example.com")])
